...
const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <BlurText
                word={"Your ultimate notes, tasks, and files management app"}
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Stay organized and boost productivity with NotesGalaxy. <span className="hidden sm:inline">The all-in-one solution for note-taking, task management, and file storage.</span>
                </p>
            </Container>
            <Container delay={0.2}>
